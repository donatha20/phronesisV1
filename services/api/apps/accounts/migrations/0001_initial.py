    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('mentee', 'Young Believer / Mentee'), ('mentor', 'Mentor / Elder'), ('admin', 'Administrator')], default='mentee', max_length=16)),
                ('avatar_initial', models.CharField(blank=True, max_length=2)),
                ('bio', models.TextField(blank=True)),
                ('focus_spheres', models.JSONField(blank=True, default=list)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_vault_unlock_at', models.DateTimeField(blank=True, null=True)),
